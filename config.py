...
_CONFIGDIRPATH = Path(os.getenv("MQTTSTUFF_CONFIG_DIR_PATH")) if os.getenv("MQTTSTUFF_CONFIG_DIR_PATH") else _CONFIGDIRPATH  # type: ignore

_CONFIGPATH: Path = Path(_CONFIGDIRPATH, "config.yaml")
_CONFIGPATH = Path(os.getenv("MQTTSTUFF_CONFIG_PATH")) if os.getenv("MQTTSTUFF_CONFIG_PATH") else _CONFIGPATH   # type: ignore

_CONFIGLOCALPATH: Path = Path(_CONFIGDIRPATH, "config.local.yaml")
_CONFIGLOCALPATH = Path(os.getenv("MQTTSTUFF_CONFIG_LOCAL_PATH")) if os.getenv("MQTTSTUFF_CONFIG_LOCAL_PATH") else _CONFIGLOCALPATH  # type: ignore

TZBERLIN: datetime.tzinfo = pytz.timezone("Europe/Berlin")

from pydantic import (
    BaseModel,
    Field, AliasPath, AliasChoices, field_validator
)
